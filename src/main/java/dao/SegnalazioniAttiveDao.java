...
public interface SegnalazioniAttiveDao {
    ...
    void cercaSegnalazioniAttive(List<String> listaPaliSegnalati, List<String> listaIndirizziDiQueiPali,List<String> listaStatoDelleSegnalazioni) throws SQLException, NonEsistonoSegnalazioniException;
}
